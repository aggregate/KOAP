...
int main(int argc, char **argv)
{
	...
	if (!checkError(errCode, "clSetKernelArg(2):")){return 0;}
		...
		errCode =
	clSetKernelArg(kernel_VecMul, 0, sizeof(cl_mem), (void*)&cl_VecAdd_arg0);
	if (!checkError(errCode, "clSetKernelArg(0):")){return 0;}

		errCode =
	clSetKernelArg(kernel_VecMul, 1, sizeof(cl_mem), (void*)&cl_VecAdd_arg1);
	if (!checkError(errCode, "clSetKernelArg(1):")){return 0;}

		errCode =
	clSetKernelArg(kernel_VecMul, 2, sizeof(cl_mem), (void*)&cl_VecAdd_arg2);
	if (!checkError(errCode, "clSetKernelArg(2):")){return 0;}
